    ...
    with tf.Session(config=config) as sess:
        ...
        while step < max_training_iters + 1:
            ...
            if step % display_step == 0:
                ...
                print("{} Iter {}: Validation Loss = {:.4f}".format(datetime.now(), step, val_batch_loss))
                print("{} Iter {}: Training Dice = {:.4f}".format(datetime.now(), step, train_dice_coef))
                print("{} Iter {}: Validation Dice = {:.4f}".format(datetime.now(), step, val_dice_coef))
